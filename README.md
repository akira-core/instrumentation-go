...
| **otel-nats** | `github.com/akira-core/instrumentation-go/otel-nats/otelnats` | 0.9.1 | Core NATS; W3C context in message headers. |
| **otel-nats** | `github.com/akira-core/instrumentation-go/otel-nats/oteljetstream` | 0.9.1 | JetStream publish/consume/fetch. |
