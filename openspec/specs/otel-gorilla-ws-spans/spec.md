# otel-gorilla-ws-spans Specification

## Purpose
Span taxonomy for otel-gorilla-ws: send PRODUCER / receive CONSUMER span kinds and the websocket.* attribute namespace (no messaging.*), including passthrough-mode behavior.
